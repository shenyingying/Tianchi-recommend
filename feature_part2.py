...
def user():
    ...
    f_U_part_1.to_csv(path_2_u, index=False)
def item():
    path_df = open(path_df_part2, 'r')
    try:
        df_part_1 = pd.read_csv(path_df, index_col=False, parse_dates=[0])
    ...
    f_I_part_1.to_csv(path_2_i, index=False)
def category():
    path_df = open(path_df_part2, 'r')
    try:
        df_part_1 = pd.read_csv(path_df, index_col=False, parse_dates=[0])
    ...
    # write to csv file
    f_C_part_1.to_csv(path_2_c, index=False)
def itemCategory():
    path_df = open(path_2_i, 'r')
    try:
    ...
    path_df = open(path_df_part2_uic_label, 'r')
    try:
    ...
    f_IC_part_1 = df_part_1_ic_u_b_count[['item_id',
                                          ...
                                          'ic_b4_rank_in_c']]
    # write to csv file
    f_IC_part_1.to_csv(path_2_ic, index=False)
def userItem():
    path_df = open(path_df_part2, 'r')
    try:
        df_part_1 = pd.read_csv(path_df, index_col=False, parse_dates=[0])
    ...
    # write to csv file
    f_UI_part_1.to_csv(path_2_ui, index=False)
def userCategory():
    path_df = open(path_df_part2, 'r')
    try:
        df_part_1 = pd.read_csv(path_df, index_col=False, parse_dates=[0])
    ...
    # write to csv file
    f_UC_part_1.to_csv(path_2_uc, index=False)
